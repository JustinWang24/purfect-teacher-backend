...
abstract class GeneralFlowsLogic implements IFlowLogic
{
     ...
     */
    public function waitingForMe($position = 0, $keyword = '')
    {
        $actionDao = new ActionDao();
        return $actionDao->getFlowsWaitingFor($this->user, $position, $keyword);
    }
     ...
     * @return mixed
     */
    public function copyToMe($position = 0, $keyword = '')
    {
        $actionDao = new ActionDao();
        return $actionDao->getFlowsWhichCopyTo($this->user,$position, $keyword);
    }

    public function myProcessed($position = 0, $keyword = '')
    {
        $actionDao = new ActionDao();
        return $actionDao->getFlowsWhichMyProcessed($this->user,$position, $keyword);
    }
     ...
     * @return IAction[]|\Illuminate\Database\Eloquent\Collection
     */
    public function startedByMe($position = 0, $keyword = '')
    {
        $actionDao = new ActionDao();
        return $actionDao->getFlowsWhichStartBy($this->user, $position, $keyword);
    }
