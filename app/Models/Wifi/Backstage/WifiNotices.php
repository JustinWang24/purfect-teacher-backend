...
class WifiNotices extends Model
{
   ...
   {
      return WifiNotices::where ( $condition )->orderByArr ( $orderArr )->joinArr ( $joinArr )->first ( $fieldsArr );
   }
   ...
   {
      return WifiNotices::where ( $condition )->orderByArr ( $orderArr )->joinArr ( $joinArr )
