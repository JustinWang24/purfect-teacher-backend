...
class WifiIssueComments extends Model
{
   ...
   {
      return WifiIssueComments::where ( $condition )->orderByArr ( $orderArr )->joinArr ( $joinArr )->first ( $fieldsArr );
   }
   ...
   {
      return WifiIssueComments::where ( $condition )->orderByArr ( $orderArr )->joinArr ( $joinArr )
