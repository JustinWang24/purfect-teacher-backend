...
class WifiContents extends Model
{
   ...
   {
      return WifiContents::where ( $condition )->orderByArr ( $orderArr )->joinArr ( $joinArr )->first ( $fieldsArr );
   }
   ...
   {
      return WifiContents::where ( $condition )->orderByArr ( $orderArr )->joinArr ( $joinArr )
