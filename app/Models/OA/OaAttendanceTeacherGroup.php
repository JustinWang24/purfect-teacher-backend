...
class OaAttendanceTeacherGroup extends Model
{
    const UNCHECKED = 0;
    ...
    protected $fillable = [
        'name',
        'morning_online_time',
        'morning_offline_time',
        'afternoon_online_time',
        'afternoon_offline_time',
        'night_online_time',
        'night_offline_time',
        'wifi_name',
        'school_id'
    ...
    public function members(){
        return $this->hasMany(OaAttendanceTeachersGroupMember::class, 'group_id', 'id');
    }
