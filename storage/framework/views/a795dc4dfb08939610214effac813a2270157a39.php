    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="index.html">
                ...
                <span class="logo-default"><?php echo e(env('APP_NAME')); ?></span> </a>
        </div>
        <!-- logo end -->
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown language-switch">
                    <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img
                                src="<?php echo e(asset('assets/img/flags/gb.png')); ?>" class="position-left" alt=""> English <span
                                class="fa fa-angle-down"></span>
                    </a>
                    <ul class="dropdown-menu">
                        <li>
                            <a class="deutsch"><img src="<?php echo e(asset('assets/img/flags/de.png')); ?>" alt=""> Deutsch</a>
                        </li>
                    </ul>
                </li>
                <!-- end language menu -->
                        ...
                        <li>
                            <ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
                                <li>
                                    <a href="#">
												<span class="photo">
													<img src="<?php echo e(asset('assets/img/prof/prof2.jpg')); ?>" class="img-circle" alt="">
												</span>
                                        <span class="subject">
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                       data-close-others="true">
                        <img alt="" class="img-circle " src="<?php echo e(asset('assets/img/dp.jpg')); ?>" />
...
</div><?php /**PATH D:\wamp64\www\etx-t\purfect-teacher-backend\resources\views/layouts/desktop/top_nav.blade.php ENDPATH**/ ?>