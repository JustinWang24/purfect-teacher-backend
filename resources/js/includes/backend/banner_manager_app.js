    ...
    new Vue({
        ...
        methods: {
          ...
          handlechange(value,type=1) {
            ...
            this.bannerFormInfo.type = !Util.isEmpty(value[2]) ? value[2] : 0;
            if ( this.bannerFormInfo.type > 0) {
              if (this.bannerFormInfo.type == 1) { // 1 => '无跳转'
                this.isshow1=false;
                this.isshow2=false;
              }
              if (this.bannerFormInfo.type == 2) { // 2 => '图文'
                this.isshow1=false;
                this.isshow2=true;
                console.log("--------图文----")
                console.log(this.isshow2);
              }
              if (this.bannerFormInfo.type == 3) { // 3 => 'URL'
                this.isshow1=true;
                this.isshow1Lable="URL";
                this.isshow1Placeholder="URL格式为：http://app.pftytx.com/";
                this.isshow2=false;
              }
              if (this.bannerFormInfo.type == 4) { // 4 => '校园网'
                this.isshow1=false;
                this.isshow2=false;
              }
              if (this.bannerFormInfo.type == 5) { // 5 => '招生主页'
                this.isshow1=false;
                this.isshow2=false;
              }
              if (this.bannerFormInfo.type == 6) { // 6 => '迎新主页'
                this.isshow1=false;
                this.isshow2=false;
              }
              if (this.bannerFormInfo.type == 7) { // 7 => '选课列表页'
                this.isshow1=false;
                this.isshow2=false;
              }
              if (this.bannerFormInfo.type == 8) { // 8 => '社区动态详情'
                this.isshow1=true;
                this.isshow1Lable="动态";
                this.isshow1Placeholder="例如：800";
              }
              if (this.bannerFormInfo.type == 11) { // 1 => '无跳转'
                this.isshow1=false;
                this.isshow2=false;
              }
              if (this.bannerFormInfo.type == 12) { // 2 => '图文'
                this.isshow1=false;
                this.isshow2=true;
              }
              if (this.bannerFormInfo.type == 13) { // 3 => 'URL'
                this.isshow1=true;
                this.isshow1Lable="URL";
                this.isshow1Placeholder="URL格式为：http://app.pftytx.com/";
                this.isshow2=false;
