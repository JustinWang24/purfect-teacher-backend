...
<div id="student-homepage-app">
    ...
    <div class="main p-15" v-if="flowsStartedByMe.length > 0" v-cloak>
        <div v-if="position !== '0'">
            <el-input placeholder="搜索标题、发起人关键字" v-model="keyword" style="margin-bottom: 10px;" @change="loadFlowsStartedByMe"></el-input>
        </div>
    ...
    <!-- <div v-if="!isLoading && flowsStartedByMe.length === 0" style="display: flex;flex-direction: column;align-items: center;background-color: #fff;margin-top: 150px;">
