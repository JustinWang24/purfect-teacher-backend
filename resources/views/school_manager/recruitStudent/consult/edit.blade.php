        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="card-box">
                ...
                <div class="card-body " id="bar-parent">
                    <form action="{{ route('school_manager.consult.edit') }}" method="post" id="edit-major-form">
                        @csrf
                        <input type="hidden" name="consult[id]" value="{{ $consult['id'] }}">
                        <div class="form-group">
                            <label for="major-name-input">问题</label>
                            <input required type="text" class="form-control" id="consult-question-input" value="{{$consult['question']}}" placeholder="问题" name="consult[question]">
                        </div>
                        <div class="form-group">
                            <label for="max-major">答案</label>
                            <textarea class="form-control" name="consult[answer]" id="major-desc-input" cols="30" rows="10" placeholder="答案">{{$consult['answer']}}</textarea>
                        </div>
